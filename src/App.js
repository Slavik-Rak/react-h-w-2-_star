...
function App() {
  ...
  let titleCartArr = [
    'Name Product 1', 'Name Product 2', 'Name Product 3', 'Name Product 4', 'Name Product 5', 'Name Product 6'
  ]
  let priceCartArr = [
          ...
          cardDelOn.map((elem, index, arrCard) => (
            ...
            <span className="wrapCardForDel" key={elem.id}>
              <div className="switchCart" >
                ...
                <span onClick={() => cartOnOf(index)}>
                  <SwitchCart />
                </span>

              </div>

              <ProductCard switchOfOn={elem.sOfOn}
                nameTitle={elem.title} price={elem.price} fotoMain={elem.fotoMain}
                fotoBest={elem.fotoBest} fotoMainR={elem.fotoMainR} ></ProductCard>
